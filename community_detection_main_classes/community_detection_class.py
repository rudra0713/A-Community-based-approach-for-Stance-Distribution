...
class Discourse_Graph:
    ...
    def apply_eva(self, topic_sent_dict):
        ...
        predicted_graph = nx.read_gml(args.predicted_graph_name + '.gml')
        ...
        with open(args.output_file_name + ".json", "w") as file_o:
    ...
    def run(self):
        ...
        nx.write_gml(self.graph, args.predicted_graph_name + '.gml')
